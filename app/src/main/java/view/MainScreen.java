...
public class MainScreen extends javax.swing.JFrame {
    ...
    private void jLabelInfosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelInfosMouseClicked
        JOptionPane.showMessageDialog(rootPane, "Develop by Matheus Xavier");
    ...
    private void jTableTasksMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableTasksMouseClicked
        ...
        switch (columnIndex) {
            ...
            case 4:
                ...
                TaskDialogScreen taskDiaogScreen = new TaskDialogScreen(this, true);
                taskDiaogScreen.setVisible(true);
                taskController.update(task);                
                break;
            case 5:
